...
//待优化 
//1.AllocFltpPcmFrame 需要每次编码分配释放内存？
//2.每次编码音视频AVPacket重复分配释放内存？

#define YUV_WIDTH 1920
#define YUV_HEIGHT 1080
#define YUV_FPS  30

#define VIDEO_BIT_RATE 5000*1024
...
//    char *out_mp4_name = argv[3];
    char in_yuv_name[] = "E:/yuv420p_1920x1080.yuv";
    char in_pcm_name[] = "E:/48000_2_s16le.pcm";
    char out_mp4_name[] = "E:/muxing.mp4";
    FILE *in_yuv_fd = NULL;
    FILE *in_pcm_fd = NULL;
    //1. 打开测试文件
    // 打开YUV文件
